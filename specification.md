...
Persisted state SHALL use Quetzal (github.com/maloquacious/quetzal)
...
The project assumes an existing independent Go package implementing the Quetzal specification (github.com/maloquacious/quetzal)
...
Z-machine state representation
   │
   ▼
Quetzal packag (github.com/maloquacious/quetzal)
   │
   ▼
[]byte
```
